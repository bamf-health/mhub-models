...
MHub - NNU-Net MultiModality Runner
       Custom runner for pre-trained nnunet models
-------------------------------------------------
...
class NNUnetPETCTRunner(Module):
    ...
    @IO.Output("out_data", 'VOLUME_001.nii.gz',
               'nifti:mod=seg:model=nnunet:roi=LIVER,KIDNEY,URINARY_BLADDER,SPLEEN,LUNG,BRAIN,HEART,STOMACH,BREAST+FDG_AVID_TUMOR',
               the="output data from nnunet")
